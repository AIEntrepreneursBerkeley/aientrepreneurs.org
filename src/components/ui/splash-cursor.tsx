...
export const SplashCursor = ({
  ...
  useEffect(() => {
    ...
    function generateColor(): ColorRGB {
      // Focus on blue, purple, and green hues
      // Blue: 0.5-0.7, Purple: 0.7-0.9, Green: 0.2-0.4
      const hueRanges = [
        { min: 0.5, max: 0.7, weight: 0.4 }, // Blue
        { min: 0.7, max: 0.9, weight: 0.4 }, // Purple
        { min: 0.2, max: 0.4, weight: 0.2 }, // Green
      ];

      // Randomly select a hue range based on weights
